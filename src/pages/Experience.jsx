export default function Experience() {
  ...
  const experiences = [
    ...
    {
      company: "FRONTEND MENTORSHIP",
      role: "Mentor",
      period: "MAR 2025 - PRESENT",
      description: [
        "Guided students in HTML, CSS, JavaScript, and React, helping them build practical web projects.",
        "Designed a performance-based scoring system to track progress and motivate students.",
        "Developed students’ problem-solving, independent thinking, and coding discipline.",
        "Provided code reviews and hands-on guidance to prepare students for real-world web development."
      ]
    }
  ];
